# Strategy Research Platform v3.2.3b

- Bumped Next.js to a patched release for RSC CVEs.
- Added npm overrides for react-server-dom-webpack and react-server-dom-parcel.
